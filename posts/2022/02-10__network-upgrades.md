...
As there is no central authority, CEO, or president of Monero, the work around deciding when to upgrade the network, what to include, and how to go about it falls to us, those people in the Monero community who choose to engage and interact! This is both an extremely important part of a decentralized project, as the planning and decision making for the project is ultimately decentralized and crowd-sourced from the community.
...
2. View tags, a brilliant way to reduce wallet sync times by 30-40%
...
These changes will go a long way to increasing the privacy, efficiency, and security of the network, all while paving the way for Seraphis, the next-generation transaction protocol for Monero.
...
- [Scheduled software upgrades (in Monero)](https://github.com/monero-project/monero?tab=readme-ov-file#scheduled-softwarenetwork-upgrades)
