...
### It preserves the privacy that Monero affords users
...
### It prevents exchanges leveraging fractional reserve lending and trading
...
For more on seed phrases, see Mnemonic Seed | Moneropedia.

### Using free and open-source wallets
...
This is the official Monero wallet software, and has seen constant improvements and additions. It includes an integrated Monero daemon (if you want), is very user-friendly, and will soon support mining via p2pool directly from your wallet.

### Feather Wallet

This is an excellent wallet in the vein of Electrum for Bitcoin, and provides both simple usability and extremely powerful features in a single wallet.
